...
import { registerUser, requestEmailVerification } from "../services/agentApi"
...
export default function SignupPage() {
  ...
  return (
    <AuthShell
      ...
      subtitle="Create a Flow account to store secure workflow settings, keep execution history under your identity, and prepare verified delivery channels."
      asideTitle="What happens after signup?"
      asideBody="We create the Flow account first, then ask the user to verify the account email. SMTP or provider credentials are configured later and remain a separate trust step."
    >
      <AuthCard
        title="Create account"
        description="Start with your Flow account credentials. Email sending credentials come later inside settings."
      >

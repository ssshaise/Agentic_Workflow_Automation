...
export default function HeroInputSection({ inputValue = "", onInputChange }: Props) {
  ...
  return (
    <section className="snap-section" style={{ display: "flex", flexDirection: "column", justifyContent: "center" }}>
      ...
      <div style={{ position: "absolute", bottom: "2rem", left: "50%", transform: "translateX(-50%)", display: "flex", flexDirection: "column", alignItems: "center", gap: "0.375rem", color: "rgba(238,228,252,0.2)", fontSize: "0.625rem", fontFamily: "Manrope,sans-serif", letterSpacing: "0.08em" }}>
        <span>SCROLL</span>
        <span className="material-symbols-outlined" style={{ fontSize: 18, animation: "pulse 2s infinite" }}>keyboard_arrow_down</span>
      </div>
    </section>
  )
}

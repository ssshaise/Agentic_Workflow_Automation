    ...
    <section className="snap-section" style={{ display: "flex", flexDirection: "column", justifyContent: "center" }}>
      <div style={{ maxWidth: 1180, margin: "0 auto", padding: "5.5rem 2.5rem", width: "100%" }}>
        <div style={{ maxWidth: 760 }}>
          <div ref={refs[0]} className="section-eyebrow reveal-hidden">
          ...
          >
            Deploy agentic workflows that browse, reason, and execute tasks across the web with precision and zero
            manual effort.
          </p>

          <div
            ref={refs[3]}
            className="reveal-hidden liquid-glass"
            style={{ borderRadius: 20, overflow: "hidden", marginBottom: "1.5rem" }}
          >
            <textarea
              value={inputValue}
            ...
            <div
              style={{
                ...
                borderTop: "1px solid rgba(190,157,255,0.08)",
              }}
            >
              <div style={{ display: "flex", gap: "0.7rem" }}>
                {[["attach_file", "Attach"], ["schedule", "Schedule"]].map(([icon, label]) => (
                  <button key={label} className="btn-glass" style={{ padding: "0.42rem 0.95rem", fontSize: "0.82rem", borderRadius: 10 }}>
              ...
              <button className="btn-primary" style={{ borderRadius: 12, padding: "0.72rem 1.55rem", fontSize: "0.92rem" }}>
                Run Workflow <span className="material-symbols-outlined" style={{ fontSize: 16 }}>bolt</span>
              </button>
            </div>
          </div>

          <div ref={refs[4]} className="reveal-hidden" style={{ display: "flex", gap: "0.85rem", flexWrap: "wrap" }}>
            {[

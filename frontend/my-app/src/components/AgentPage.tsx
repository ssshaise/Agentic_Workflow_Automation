...
const mockHistory = [
  { id: "WKF-8821-X", name: "arXiv Monitor → Email", status: "completed", time: "2 hours ago", duration: "1m 42s" },
  { id: "WKF-8820-A", name: "Inventory Sync", status: "completed", time: "5 hours ago", duration: "0m 18s" },
  { id: "WKF-8819-B", name: "Market Sentiment", status: "failed", time: "Yesterday", duration: "0m 55s" },
  { id: "WKF-8818-C", name: "Smart Scheduler", status: "completed", time: "Yesterday", duration: "0m 32s" },
  { id: "WKF-8817-D", name: "Error Monitor", status: "completed", time: "2 days ago", duration: "2m 10s" },
]
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "0.75rem" }}>
          {mockHistory.map(h => (
            <div key={h.id} className="liquid-glass" style={{ borderRadius: 12, padding: "1rem 1.25rem", display: "flex", alignItems: "center", gap: "1rem" }}>
              <div style={{ width: 8, height: 8, borderRadius: "50%", background: statusColor[h.status], flexShrink: 0 }} />
              <div style={{ flex: 1 }}>
              ...
              <div style={{ display: "flex", gap: "0.5rem" }}>
                <button className="btn-glass" style={{ fontSize: "0.6875rem", padding: "0.25rem 0.75rem", borderRadius: 8 }}>
  ...
  return (
    <div style={{ padding: "2.5rem 2rem", maxWidth: 720 }}>
      ...
      <div style={{ display: "flex", gap: "0.75rem" }}>
        ...
        <button className="btn-glass" style={{ borderRadius: 10 }}>
